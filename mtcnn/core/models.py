...
class PNet(nn.Module):
    ...
    def __init__(self, is_train = False, use_cuda = True):
        ...
        self.conv4_3 = nn.Conv2d(32, 136, kernel_size=1, stride=1)   # 68-points | 5-points
...
class RNet(nn.Module):
    ...
    def __init__(self,is_train=False, use_cuda=True):
        ...
        self.conv5_3 = nn.Linear(128, 136)     # lanbmark localization
...
class ONet(nn.Module):
    ...
    def __init__(self, is_train = False, use_cuda = True):
        ...
        self.conv6_3 = nn.Linear(256, 136)              # 68 <--> 136; 5 <--> 10
