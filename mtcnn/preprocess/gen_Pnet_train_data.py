...
from mtcnn.preprocess.utils import IoU

from IPython import embed

root_dir  = '/home/faceu' # temporary
im_dir    = os.path.join(root_dir, 'face_detection/WIDER_train/images')
part_save_dir = os.path.join(root_dir, '68keypoints/pnet/part')
pos_save_dir  = os.path.join(root_dir, '68keypoints/pnet/positive')
neg_save_dir  = os.path.join(root_dir, '68keypoints/pnet/negative')
...
anno_file = os.path.join(anno_dir, 'wide_anno_train.txt')
...
for idx, im_anno in enumerate(annotations):

    annotation = im_anno.strip().split(' ')
